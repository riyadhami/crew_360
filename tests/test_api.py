...
def test_a_scoring_answer_is_plain_english_with_the_apparatus_underneath(client):
    ...
    payload = _ask(client, "How is IGA60406 performing?")
...
def test_a_scoring_answer_carries_its_own_audit(client):
